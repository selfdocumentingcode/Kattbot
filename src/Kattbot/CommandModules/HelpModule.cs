...
public class HelpModule : BaseCommandModule
{
    ...
    public Task GetHelp(CommandContext ctx)
    {
        ...
        sb.AppendLine($"`{commandPrefix}gpt-image [?image] [text]`");
        ...
        sb.AppendLine();
        sb.AppendLine(
            "Kattbot source code: [github.com/selfdocumentingcode/Kattbot](https://github.com/selfdocumentingcode/Kattbot)");
    ...
    public Task GetStatsHelp(CommandContext ctx)
    {
        ...
        DiscordEmbed eb = EmbedBuilderHelper.BuildSimpleEmbed("Check out random emote related stats", sb.ToString());
    ...
    public Task GetImagesHelp(CommandContext ctx)
    {
        ...
        sb.AppendLine($"`{commandPrefix}gpt-image [?image] [text]`");
        sb.AppendLine($"`{commandPrefix}gpt-image-emote [emote] [text]`");
        sb.AppendLine($"`{commandPrefix}gpt-image-avatar [user] [text]`");
        ...
        DiscordEmbed eb = EmbedBuilderHelper.BuildSimpleEmbed("Stuff you can do with images", sb.ToString());
