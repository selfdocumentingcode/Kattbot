...
public class GptImageEmoteHandler : IRequestHandler<GptImageEmoteCommand>
{
    ...
    public GptImageEmoteHandler(GptImagesHttpClient gptImagesHttpClient, ImageService imageService)
    {
